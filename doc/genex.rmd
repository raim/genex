...
Note that these equations are purely empirical, since the model
simplifies multiple steps of complex formation (inducer and transcription
factor, transcription factor on promoter) and subsumes both transcription
and translation. Nevertheless, the parameters may roughly reflect 
...
but minimally: $\int \frac{e^{\beta t}}{1+e^t} \text{d}t= 
\frac{e^{\beta t}}{b} _2\text{F}_1(1,b;b+1;-e^x)$).
